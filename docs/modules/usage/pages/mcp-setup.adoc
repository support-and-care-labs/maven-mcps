...
Maven Tools MCP::
Maven Central dependency intelligence (versions, health analysis).
No account required (public repository).
...
For detailed configuration and available tools, see xref:maven-tools-mcp-setup.adoc[Maven Tools MCP Detailed Setup].
