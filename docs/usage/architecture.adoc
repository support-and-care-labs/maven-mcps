...
// mail-mcp-docs: path to mail-mcp documentation
// mail-mcp-github: always points to GitHub (for README, etc.)
:mail-mcp-docs: ../../mail-mcp/docs
:mail-mcp-github: https://github.com/support-and-care-labs/mail-mcp/blob/main
ifdef::env-github[]
...
:toc:
:toclevels: 3
ifndef::env-site[:imagesdir: diagrams]
ifdef::env-site[:imagesdir: /images]
:minisite-index: 110
:minisite-index-title: Architecture
:minisite-index-icon: fas fa-sitemap
:minisite-index-description: System architecture and deployment overview
...
* xref:{mail-mcp-docs}/index.adoc[mail-mcp configuration]
