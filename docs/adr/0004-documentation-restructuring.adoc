...
* Implement cross-reference attributes for multi-context rendering (Issue 1)
* Configure GitHub rendering compatibility (Issue 2)
* Set up documentation site generation with Antora or similar (Issue 3)
