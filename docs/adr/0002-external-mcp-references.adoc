...
* link:0001-documentation-standards.adoc[ADR-0001: Documentation Standards]
* link:../external/README.adoc[External MCP Documentation Guidelines]
* link:../external/index.adoc[External MCP Catalog]