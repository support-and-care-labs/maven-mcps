...
Provider:: https://github.com/modelcontextprotocol/servers/tree/main/src/github[Model Context Protocol]
...
GitHub MCP requires manual setup.
See xref:usage:github-mcp-setup.adoc[GitHub MCP Setup] for installation instructions.

For the upstream MCP server documentation, see the https://github.com/modelcontextprotocol/servers/tree/main/src/github[MCP GitHub Server repository].
