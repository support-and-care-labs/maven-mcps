...
Generated within each application's profile settings (Profile → Personal Access Tokens).
For Apache infrastructure:
* Confluence: https://cwiki.apache.org/confluence[cwiki.apache.org] → Profile → Settings → Personal Access Tokens
* Jira: https://issues.apache.org/jira[issues.apache.org] → Profile → Personal Access Tokens
+
